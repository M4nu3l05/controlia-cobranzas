...
class DeudorResumen(Base):
    ...
    ejecutivo_asignado: Mapped[str] = mapped_column(String(255), nullable=False, default="")
    analista_asignado: Mapped[str] = mapped_column(String(255), nullable=False, default="")
...
class DeudorDetalle(Base):
    ...
    direccion_deudor: Mapped[str] = mapped_column(String(500), nullable=False, default="")
    comuna_deudor: Mapped[str] = mapped_column(String(120), nullable=False, default="")
    ciudad_deudor: Mapped[str] = mapped_column(String(120), nullable=False, default="")

    nro_expediente: Mapped[str] = mapped_column(String(80), index=True, nullable=False, default="")
    id_deuda: Mapped[str] = mapped_column(String(80), nullable=False, default="")
    endoso: Mapped[str] = mapped_column(String(80), nullable=False, default="")
    periodo: Mapped[str] = mapped_column(String(40), nullable=False, default="")
    cuota: Mapped[str] = mapped_column(String(40), nullable=False, default="")
    fecha_vencimiento: Mapped[str] = mapped_column(String(40), nullable=False, default="")
    fecha_emision: Mapped[str] = mapped_column(String(40), nullable=False, default="")
    moneda: Mapped[str] = mapped_column(String(20), nullable=False, default="")
    impago_en_mo: Mapped[str] = mapped_column(String(80), nullable=False, default="")
    observaciones: Mapped[str] = mapped_column(Text, nullable=False, default="")
    compania: Mapped[str] = mapped_column(String(120), nullable=False, default="")
    fecha_corte_beneficios: Mapped[str] = mapped_column(String(40), nullable=False, default="")
    prestador: Mapped[str] = mapped_column(String(255), nullable=False, default="")
    fecha_prestacion: Mapped[str] = mapped_column(String(40), nullable=False, default="")
    fecha_prestacion2: Mapped[str] = mapped_column(String(40), nullable=False, default="")

    copago: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    total_pagos: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    saldo_actual: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    monto_total: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    monto_cobrar: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    monto_facturado: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    monto_liquidado: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    monto_pagado_parcial: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    monto_condonado: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    monto_gestionado: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    cuota_acordada: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
